...
Future<void> setupServiceLocator({
  ...
  getIt
    ...
    ..registerLazySingleton<feat_cart.CartService>(feat_cart.CartService.new)
    ...
    ..registerLazySingleton<HomeRepository>(
      () => HomeRepository(homeService: getIt()),
    )
    ..registerLazySingleton<ContactRepo>(ContactRepo.new)
    ..registerLazySingleton<ProfileRepo>(() => ProfileRepo(service: getIt()))
    // 4. Domain UseCases
    ...
    ..registerFactory<HomeCubit>(() => HomeCubit(useCase: getIt()))
    ..registerFactory<ContactCubit>(() => ContactCubit(getIt()))
    ..registerFactory<ProfileCubit>(
      () => ProfileCubit(profileRepo: getIt(), authService: getIt()),
    );
}
