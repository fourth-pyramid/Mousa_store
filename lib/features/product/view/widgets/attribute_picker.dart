              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected
                      ...
                      : (isAvailable ? context.colors.border : context.colors.surface),
                  width: 0.5.w,
                ),
              ),
              child: Center(
                    ...
                    Text(
                      ...
                      style: context.typography.body.copyWith(
                        ...
                        color: isSelected
                            ...
                            : (isAvailable ? context.colors.textPrimary : context.colors.textSecondary),
                      ),
                    ),
                    if (!isAvailable)
                      Transform.rotate(
                        angle: -0.5,
                        child: Container(width: 30.w, height: 1.5.h, color: context.colors.border),
                      ),
                  ],
                ),
              ),
