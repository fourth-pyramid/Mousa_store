// ignore_for_file: avoid_dynamic_calls // Dynamic Map items used for declarative profile navigation settings rows
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<PriceModeCubit, PriceModeState>(
        builder: (context, priceModeState) =>
            BlocBuilder<ThemeCubit, ThemeState>(
              builder: (context, themeState) =>
                  BlocBuilder<LanguageCubit, LanguageState>(
                    builder: (context, languageState) {
                      final themeText = switch (themeState.themeMode) {
                        ThemeMode.light => context.l10n.light_mode_text,
                        ThemeMode.dark => context.l10n.dark_mode_text,
                        ThemeMode.system => context.l10n.system_mode_text,
                      };
                      ...
                      final purchaseTypeText =
                          priceModeState.mode == PriceMode.wholesale
                      ...
                      final sections = [
                            ...
                            if (isLoggedIn)
                              {
                                ...
                                'subtitle': context
                                    .l10n
                                    .change_personal_information_text,
                        ...
                        },
                        {
                          ...
                          'items': [
                            ...
                            {
                              'title':
                                  context.l10n.choose_your_type_of_shopping,
                              'subtitle': purchaseTypeText,
                              'icon': Icons.storefront_outlined,
                              'onTap': () => unawaited(
                                AppBottomSheet.show<void>(
                                  context: context,
                                  child: const PurchaseTypeSelectionSheet(),
                                ),
                              ),
                            },
                          ],
        ...
        builder: (_) => AlertDialog(
          ...
          actions: [
            TextButton(
              ...
              child: Text(localizations.cancel_text),
            ),
            AppButton(
