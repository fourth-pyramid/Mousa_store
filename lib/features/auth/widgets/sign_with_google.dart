      ...
      children: [
        ...
        SizedBox(
          ...
          child: OutlinedButton.icon(
            ...
            icon: AppImage.asset('assets/images/google_button.png', height: 22.h, width: 22.w),
            label: Text(
              'Google',
              style: context.typography.labelLarge.copyWith(color: context.colors.textPrimary, fontWeight: FontWeight.w600),
            ),
          ),
        ),
      ],
